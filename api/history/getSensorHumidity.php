...
$sql = "(SELECT param, name, event, value FROM sensors WHERE param = 'HUMIDITY'" . $swhere . ") UNION (SELECT param, 'DEMAND' as name, event, value FROM demands WHERE param = 'HUMIDITY')";
// echo "SQL\n".$sql."\n";
